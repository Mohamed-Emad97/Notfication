      ...
      <div className="container">
        <div className="notfyCard rounded-2 d-flex gap-2 align-items-center p-3">
          ...
          <div className="content">
            {/* <p className='desc mb-0 d-flex align-items-center justify-content-center flex-lg-row flex-md-row flex-sm-row flex-column'></p> */}
            <div className="">
        ...
        <div className="notfyCard bg-transparent rounded-2 d-flex justify-content-between mt-2 align-items-center p-3">
